        ...
        SessionStart: [
          {
            matcher: 'startup',
            hooks: [
              { type: 'command', command: '$CLAUDE_PROJECT_DIR/.claude/hooks/load-behavioral-system.sh' },
              { type: 'command', command: '$CLAUDE_PROJECT_DIR/.claude/hooks/auto-branch.sh' }
            ]
          },
          {
            matcher: 'resume',
        ...
        PreToolUse: [
          {
            matcher: 'Bash',
            hooks: [
              { type: 'command', command: '$CLAUDE_PROJECT_DIR/.claude/hooks/block-destructive-commands.sh' }
            ]
          },
          {
            matcher: 'Write|Edit|MultiEdit',
            hooks: [
              { type: 'command', command: '$CLAUDE_PROJECT_DIR/.claude/hooks/directive-enforcer.sh' },
              { type: 'command', command: '$CLAUDE_PROJECT_DIR/.claude/hooks/collective-metrics.sh' },
        ...
        PostToolUse: [
          {
            matcher: 'Task',
            hooks: [
              { type: 'command', command: '$CLAUDE_PROJECT_DIR/.claude/hooks/test-driven-handoff.sh' },
              { type: 'command', command: '$CLAUDE_PROJECT_DIR/.claude/hooks/collective-metrics.sh' },
              { type: 'command', command: '$CLAUDE_PROJECT_DIR/.claude/hooks/auto-checkpoint.sh' },
              { type: 'command', command: '$CLAUDE_PROJECT_DIR/.claude/hooks/auto-squash.sh' }
            ]
          },
          {
            matcher: 'Write|Edit|MultiEdit',
        ...
        SubagentStop: [
          {
            matcher: 'mock-.*',
            hooks: [
              { type: 'command', command: '$CLAUDE_PROJECT_DIR/.claude/hooks/mock-deliverable-generator.sh' },
              { type: 'command', command: '$CLAUDE_PROJECT_DIR/.claude/hooks/test-driven-handoff.sh' },
              { type: 'command', command: '$CLAUDE_PROJECT_DIR/.claude/hooks/collective-metrics.sh' }
            ]
          },
