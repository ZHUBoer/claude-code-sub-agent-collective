class CommandAutocomplete {
  ...
  getSuggestions(partial, context = {}) {
    ...
    if (partial.startsWith("/")) {
      ...
      if (parts.length === 1) {
        ...
        suggestions.push(
          ...this.getArgumentSuggestions(namespace, command, parts.slice(2))
        );
      }
    } else {
    ...
    if (namespace === "collective") {
      if (command === "research") {
        suggestions.push(
          {
            text: "h1_jitLoading",
            description: "JIT Context Loading hypothesis",
            type: "argument",
          },
          {
            text: "h2_hubSpoke",
            description: "Hub-and-Spoke Coordination hypothesis",
            type: "argument",
          },
          {
            text: "h3_tddHandoff",
            description: "Test-Driven Handoffs hypothesis",
            type: "argument",
          }
        );
        ...
        suggestions.push(
          {
            text: "system",
            description: "Validate entire collective system",
            type: "argument",
          },
          {
            text: "agents",
            description: "Validate agent registry",
            type: "argument",
          },
          {
            text: "hooks",
            description: "Validate hook integration",
            type: "argument",
          },
          {
            text: "behavioral",
            description: "Validate behavioral system",
            type: "argument",
          }
        );
      }
      ...
      if (command === "spawn") {
        if (argIndex === 0) {
          suggestions.push(
            {
              text: "component",
              description: "UI component development agent",
              type: "argument",
            },
            {
              text: "feature",
              description: "Business logic implementation agent",
              type: "argument",
            },
            {
              text: "testing",
            ...
            {
              text: "infrastructure",
              description: "Build systems and tooling agent",
              type: "argument",
            },
            {
              text: "behavioral-transformation",
              description: "CLAUDE.md transformation agent",
              type: "argument",
            }
          );
        } else if (argIndex === 1) {
          suggestions.push(
            {
              text: "integration",
              description: "Integration testing specialization",
              type: "argument",
            },
            {
              text: "unit",
            ...
            {
              text: "e2e",
              description: "End-to-end testing specialization",
              type: "argument",
            },
            {
              text: "performance",
              description: "Performance testing specialization",
              type: "argument",
            },
            {
              text: "accessibility",
              description: "Accessibility testing specialization",
              type: "argument",
            }
          );
        }
        ...
        suggestions.push(
          {
            text: "routing-agent",
            description: "Main routing coordination agent",
            type: "argument",
          },
          {
            text: "behavioral-transformation-agent",
            description: "Behavioral system agent",
            type: "argument",
          },
          {
            text: "testing-implementation-agent",
            description: "Testing framework agent",
            type: "argument",
          },
          {
            text: "component-implementation-agent",
            description: "Component development agent",
            type: "argument",
          },
          {
            text: "feature-implementation-agent",
      ...
      if (command === "validate" || command === "enforce") {
        suggestions.push(
          {
            text: "planning",
            description: "Planning phase gate validation",
            type: "argument",
          },
          {
            text: "infrastructure",
            description: "Infrastructure phase gate validation",
            type: "argument",
          },
          {
            text: "implementation",
            description: "Implementation phase gate validation",
            type: "argument",
          },
          {
            text: "testing",
            description: "Testing phase gate validation",
            type: "argument",
          },
          {
            text: "polish",
            description: "Polish phase gate validation",
            type: "argument",
          },
          {
            text: "completion",
            description: "Completion phase gate validation",
            type: "argument",
          }
        );
        ...
        if (argIndex === 0) {
          suggestions.push(
            ...
            {
              text: "testing-gate",
              description: "Testing quality gate",
              type: "argument",
            },
            {
              text: "completion-gate",
              description: "Completion quality gate",
              type: "argument",
            }
          );
        } else if (argIndex >= 1) {
          suggestions.push(
            ...
            },
            {
              ...
              description: "Critical hotfix bypass",
              type: "argument",
            },
            {
            ...
            },
            {
              ...
              description: "Security update bypass",
              type: "argument",
            }
          );
        }
  ...
  getCommandsForIntent(intent) {
    const intentCommands = {
      ...
      list: [
        ...
        {
          command: "/collective agents",
          description: "List collective agents",
        },
      ],
      create: [{ command: "/agent spawn", description: "Create new agent" }],
      validate: [
      ...
      status: [{ command: "/collective status", description: "System status" }],
      metrics: [
  ...
  rankSuggestions(suggestions, partial, context) {
    ...
    unique.sort((a, b) => {
      ...
      const aStartsExact = a.text
        .toLowerCase()
        .startsWith(partial.toLowerCase());
      const bStartsExact = b.text
        .toLowerCase()
        .startsWith(partial.toLowerCase());
